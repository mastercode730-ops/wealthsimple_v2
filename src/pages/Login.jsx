...
const Login = ({ onBack, onSignupClick }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // login success handled by auth context
    } catch (err) {
              ...
              <div className="bg-red-500/10 border border-red-500/50 text-red-400 text-sm px-4 py-3 rounded-xl mb-4 text-center leading-relaxed">
                ...
                {loginAttempts >= 3 && (
                  ...
                  >
                    ...
                    Facing issue with login? Chat with us
                  </button>
                )}
              </div>
            )}
            ...
            >
              ...
              <div className="relative mt-3">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-full bg-[#3a3a3a] text-fintech-textDark hover:bg-[#4a4a4a] transition-colors cursor-pointer"
                >
                  {showPassword ? (
