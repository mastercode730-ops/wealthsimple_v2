...
const TldrSection = () => {
  return (
    <section className="w-full bg-fintech-lighter flex flex-col items-center justify-center py-24 relative overflow-hidden">
      ...
      >
        <div className="fintech-glass flex flex-col md:flex-row items-center gap-10 p-10 md:p-14">
          <div className="flex-1 text-center md:text-left">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-fintech-textDark leading-tight mb-6" style={{ fontFamily: 'Playfair Display, serif' }}>
          ...
          <div className="w-full md:w-[350px] shrink-0 bg-white/5 border border-white/10 rounded-2xl p-6">
            <h4 className="text-fintech-textDark font-medium mb-4">Subscribe to the newsletter</h4>
            <div className="flex flex-col gap-3">
              <input 
                type="email" 
                placeholder="name@example.com" 
                className="w-full bg-white/40 border border-fintech-border text-fintech-textDark px-4 py-3 rounded-lg outline-none focus:border-fintech-blue transition-colors placeholder:text-neutral-600"
              />
              <button className="w-full bg-fintech-blue text-fintech-textDark font-medium py-3 rounded-lg hover:bg-blue-600 transition-colors shadow-sm">
                Get Insights
              </button>
            </div>
