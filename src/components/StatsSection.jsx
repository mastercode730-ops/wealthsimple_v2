...
const StatsSection = ({ onSignupClick }) => {
    ...
    <section className="py-24 md:py-40 text-center bg-[#f4f3ef] relative">
      <div className="container-custom flex flex-col items-center relative z-10">
        ...
        <button 
          ...
          className="px-10 py-5 rounded-[100px] border border-[#2d2a26] text-[#2d2a26] text-[14px] font-normal hover:bg-black/5 transition-colors cursor-pointer mb-24"
        >
          Get started
        </button>
