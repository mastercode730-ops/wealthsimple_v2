...
const StatsSection = () => {
  return (
    <section className="py-24 md:py-32 bg-fintech-lighter border-t border-fintech-border/50 relative">
      <div className="container-custom max-w-6xl mx-auto px-6 relative z-10">
        
        <div className="flex flex-col items-center text-center mb-16">
          <h2
            className="text-4xl md:text-6xl lg:text-7xl font-bold text-fintech-textDark mb-6 leading-tight"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {[
            ...
            <motion.div 
              ...
              className="bg-fintech-light border border-fintech-border p-8 flex flex-col items-start rounded-xl hover:border-fintech-emerald transition-colors"
            >
              ...
              <h3 className="text-fintech-textDark text-3xl font-bold mb-4 font-serif">{stat.title}</h3>
