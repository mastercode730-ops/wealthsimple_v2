...
const HeroSection = ({ onSignupClick }) => {
  return (
    <section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center overflow-hidden bg-fintech-darker">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-fintech-darker/40 via-fintech-darker/60 to-fintech-darker opacity-90"></div>
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center justify-center text-center px-6 pt-24 pb-16">
        ...
        <h1
          className="text-5xl md:text-7xl font-serif font-bold text-white mb-6 drop-shadow-lg leading-tight tracking-tight"
        >
        ...
        <p className="text-lg md:text-xl text-neutral-300 max-w-2xl mb-12 font-medium">
